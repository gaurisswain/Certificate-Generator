...
import cv2
import csv
csv_file = "IITBSports.csv"
txt_file = "list_of_names.txt"
...
def generate_certificates():
   ...
   for index, name in enumerate(list_of_names):
      certificate_template_image = cv2.imread("E-Certificate.jpg")
      cv2.putText(certificate_template_image, name.strip(), (110,155), cv2.FONT_HERSHEY_SIMPLEX, 5, (4, 0, 0), 5, cv2.LINE_AA)
